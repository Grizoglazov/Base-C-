...
public:
	...
	void setNum();							// метод для настройки и проверки num1 и num2 
	void showNumConsole() const;			// метод вывода значений num1 и num2 в консоль  
...
void Calculator::showNumConsole() const { std::cout << "num1 = " << num1 << " , " << "num2 = " << num2 << std::endl; }
...
void printData() {
	...
	do
	{
		...
		std::cout << "******************************\n";
		std::cout << "Продолжить нажми 1 или выйти нажми 0\n";
		int exit;
		std::cin >> exit;
		if (exit != 1)
			resume = false;
